            ...
            <Center>
                <Box width="80%">
                    <div className="font-face-sfpb" style={{ color: "white", fontSize: DUNGEON_FONT_SIZE }}>
                        ...
                        <br />
                        If you have any questions that aren't covered in the FAQ, or find any technical issues with the site, please head
                        over to our Discord channel and make a support ticket to let us know.
                    </div>
                </Box>
            </Center>
        </>
