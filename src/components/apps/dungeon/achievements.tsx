...
export const AchievementMetaData : Achievement[] = [
    ...
    {name: "Gotta Kill 'em All", description: "Kill 10 types of enemy", image: kill_em_all, type: 0, secret: false, percent: 2.3},
    {name: "Rookie", description: "Kill a tier 1 boss", image: rookie, type: 0, secret: false, percent: 5.8},
    {name: "Adventurer", description: "Kill a tier 1 boss 10 times", image: adventurer, type: 0, secret: false, percent: 3.1},
    {name: "Bat Out Of Hell", description: "Kill a tier 2 boss", image: bat_out_of_hell, type: 0, secret: false, percent: 1.5},
    ...
    {name: "We Could Have Been Friends", description: "Defeat the Assassin as the Ranger", image: could_have_bee_friends, type: 0, secret: true, percent: 0.8},
    {name: "Yerr a Wizard, Harry", description: "Defeat the Dungeon Master as the Wizard", image: yerr_a_wizard, type: 0, secret: true, percent: 0.2},
    ...
    {name: "Cautious", description: "Escape level 1 10 times", image: cautious, type: 1, secret: false, percent: 0.8},
    {name: "Coward", description: "Escape level 1 100 times", image: coward, type: 1, secret: false, percent: 0},
    {name: "Daily Dungeon I", description: "Enter the Dungeon on 5 consecutive days", image: daily_dungeon_1, type: 0, secret: false, percent: 4.5},
    ...
    {name: "Once You Pop...", description: "Play 100 rounds in a day", image: once_you_pop, type: 0, secret: true, percent: 1.7},
