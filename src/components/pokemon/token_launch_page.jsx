...
function PostContent() {
    ...
    return (
        ...
        <div className="container">
            ...
            This token launch has been funded with 50 million Play Tokens, which is enough for between 25 and 50 thousand participants, and will shut down when those tokens have been exhausted.  From that point on the only way to receive Play Tokens from DaoPlays directly will be by taking part in the token auction with other users from the <Link style={{textDecoration: "underline"}} to="/pokemon">main app page</Link> (for more details please see our blog post on the DaoPlays Pokemon app <Link style={{textDecoration: "underline"}} to="/blog/pokemon_guide">here</Link>).
